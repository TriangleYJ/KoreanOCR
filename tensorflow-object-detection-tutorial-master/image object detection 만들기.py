...
PATH_TO_GRAPH = os.path.join(SCRIPT_PATH, '../tensorflow-hangul-recognition-master/saved-model/optimized_hangul_tensorflow.pb')

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join(SCRIPT_PATH, './data/hangul.pbtxt')
